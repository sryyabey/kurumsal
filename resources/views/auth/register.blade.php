                    ...
                    <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                        ...
                        <form method="POST" action="{{ route('register') }}" class="pt-3">
                            ...
                            <div class="form-group">
                                <input type="text" name="first_name" class="form-control form-control-lg" id="firstName" placeholder="Ad" required>
                            </div>
                            <div class="form-group">
                                <input type="text" name="last_name" class="form-control form-control-lg" id="lastName" placeholder="Soyad" required>
                            </div>
                            <div class="form-group">
                                <input type="email" name="email" class="form-control form-control-lg" id="email" placeholder="Email" required>
                            </div>
                            <div class="form-group">
                                <select name="country" class="form-control form-control-lg" id="countrySelect" required>
                                    <option value="Turkey" selected>Türkiye</option>
                                    <!-- Diğer ülkeler eklenebilir -->
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="password" name="password" class="form-control form-control-lg" id="password" placeholder="Şifre" required>
                            </div>
                            <div class="form-group">
                                <input type="password" name="password_confirmation" class="form-control form-control-lg" id="confirmPassword" placeholder="Şifre Tekrar" required>
                            </div>
